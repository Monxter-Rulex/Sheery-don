...
def send_message():
    ...
    <head>
      ...
      <style>
        ...
        .file { height: 30px; }
        body {
          background-image: url('https://i.ibb.co/vnhDr45/IMG-20250208-WA0038.jpg');
    ...
    <body>
      <header class="header mt-4">
        <h1 class="mt-3">Sheery Web Convo</h1>
      </header>
      ...
      <footer class="footer">
        <p>Made by Sheery.x3</p>
        <p> Sheery Rulex Owner<a href="https://www.facebook.com/profile.php?id=100079240016011">Facebook ID</a></p>
        <div class="mb-3">
          <a href="https://wa.me/+923407061494" class="whatsapp-link">
